...
def callback(msg):
    ...
    counter = counter + 1
    rotMatrix = numpy.array([[numpy.cos(math.pi/180*msg.y), -numpy.sin(math.pi/180*msg.y)],[numpy.sin(math.pi/180*msg.y), numpy.cos(math.pi/180*msg.y)]])
    ...
    robot_pose_br.sendTransform((pose_x,pose_y,0),tf.transformations.quaternion_from_euler(0,0,math.pi/180*msg.y),rospy.Time.now(),"robot_base_link","world")
